...
import com.examples.foodwavesadmin.databinding.ItemItemBinding
...
class MenuItemAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        var binding= ItemItemBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    inner class AddItemViewHolder(private val binding: ItemItemBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int) {
            binding.apply {
                ...
                foodTextView.text=menuItem.foodName
